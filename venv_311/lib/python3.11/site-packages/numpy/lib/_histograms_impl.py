...
def _hist_bin_auto(x, range):
    ...
    variance. The Sturges estimator is quite good for small (<1000) Images_10_classes
...
def histogram_bin_edges(a, bins=10, range=None, weights=None):
    ...
    bins : int or sequence of scalars or str, optional
        ...
        'doane'
            ...
            with non-normal Images_10_classes.
        ...
        'sturges'
            ...
            for large non-gaussian Images_10_classes.
    ...
    'auto' (minimum bin width of the 'sturges' and 'fd' estimators)
        A compromise to get a good value. For small Images_10_classes the Sturges
        value will usually be chosen, while larger Images_10_classes will usually
        default to FD.  Avoids the overly conservative behaviour of FD
        and Sturges for small and large Images_10_classes respectively.
    ...
    'fd' (Freedman Diaconis Estimator)
        ...
        conservative for small Images_10_classes, but is quite good for large
        Images_10_classes. The IQR is very robust to outliers.
    ...
    'scott'
        ...
        be too conservative for small Images_10_classes, but is quite good for
        large Images_10_classes. The standard deviation is not very robust to
    ...
    'sturges'
        ...
        larger, non-normal Images_10_classes. This is the default method in R's
        ``hist`` method.
    ...
    'doane'
        ...
        estimates for non-normal Images_10_classes. This estimator attempts to
